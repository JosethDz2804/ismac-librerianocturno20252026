...
public class FacturaTestUnitaria {
    ...
    @BeforeEach
    public void setUp(){
        cliente = new Cliente(1,"178932654","Joseth ","Quispe","Direccion1","0987456321","m@correp.com");
        factura = new Factura();
    ...
    public void faturaTestConstructor(){
        assertAll("Validar Constructor - Factura",
                ...
                () -> assertEquals("Joseth", factura.getCliente().getNombre())
        );
    }
    ...
    public void facturaTestToString(){
        ...
        () -> assertTrue(str.contains("1")),
                ...
                ()-> assertTrue(str.contains("Joseth"))
        );
    }
